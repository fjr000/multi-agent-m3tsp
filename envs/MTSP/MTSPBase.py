...
class MTSPEnv:
    ...
    def _get_salesmen_states(self):
        ...
        self.states[..., 8] = max_cost / scale
        self.states[..., 9] = min_cost / scale
        self.states[..., 10] = max_max_dist_depot / scale
        self.states[..., 11] = progress
    ...
    def _get_masks_in_salesmen(self):
        ...
        global_invert = ~self.salesmen_mask[:,:,0] # Shape [B, A]
        ...
        self.masks_in_salesmen = global_invert[:,None,]
