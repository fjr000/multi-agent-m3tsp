...
from model.Model_AC.model_v1 import Model
import torch
from utils.TensorTools import _convert_tensor
import numpy as np
from algorithm.DNN_C.AgentBase import AgentBase
import tqdm
...
if __name__ == '__main__':
    ...
    loss_list = []
    act_logp, agents_logp, costs = agent.run_batch_episode(env, graph, args.agent_num, eval_mode=False, exploit_mode="sample")
