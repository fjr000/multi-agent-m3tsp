...
import argparse
from envs.MTSP.MTSPMASK import MTSPEnv
from algorithm.DNN5.AgentV7 import Agent as Agent
import tqdm
...
def tensorboard_write(writer, train_count, act_loss, alpha, grad, lr):
    writer.add_scalar("train/act_loss", act_loss, train_count)
    writer.add_scalar("train/alpha", alpha, train_count)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--grad_max_norm", type=float, default=100)
