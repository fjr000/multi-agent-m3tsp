...
from algorithm.EVDA.AgentV1 import Agent as Agent
import tqdm
...
if __name__ == "__main__":
    ...
    for epoch in range(args.n_epoch):
        ...
        agent.save_model(args.agent_id + epoch + 1)
        print(f"Saving Model {args.agent_id + epoch + 1}")
